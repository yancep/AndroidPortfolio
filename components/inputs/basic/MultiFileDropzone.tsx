...
//   active: 'border-2 border-gray-500 bg-green-50 dark:bg-green-900',
...
//   accept: 'border border-green-500 bg-green-500 bg-opacity-10',
...
//     return `You can only add ${maxFiles} file(PctCertificationConfigView).`;
//   },
//   fileNotSupported() {
...
//   (
//     { dropzoneOptions, value, className, disabled, onFilesAdded, onChange , handleDropZone},
//     ref,
//   ) => {
...
//           handleDropZone(acceptedFiles[0]);
//         }
//       },
//       ...dropzoneOptions,
//     });
